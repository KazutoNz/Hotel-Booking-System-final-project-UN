        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">จัดการรายการจอง</h1>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">รายการจองแต่ละโรงแรมทั้งหมด</h6>
                        </div>
                        <div class="card-body">
                ...
                <?php include '../../BackEnd/modal_manage_order.php'; ?>
