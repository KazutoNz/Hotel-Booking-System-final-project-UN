...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">จัดการห้องพัก</h1>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">รายการโรงแรมและจำนวนห้องพัก</h6>
                        </div>
                        <div class="card-body">
                ...
                <!-- Modal สำหรับจัดการห้องพัก -->
                <?php include '../../BackEnd/modal_manage_rooms.php'; ?>
    ...
    <!-- ✅ โหลด manage_rooms.js หลัง DataTables -->
    <script src="../../js/manage_rooms.js"></script>
