...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <!-- ✅ เพิ่ม DataTables แสดงรายการโรงแรม -->
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800">รายการโรงแรม</h1>
    ...
    <script src="../../js/show_hotels.js"></script>
